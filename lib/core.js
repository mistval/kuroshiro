            ...
            if (options.mode === "okurigana") {
              for (let n0 = 0; n0 < notations.length; n0++) {
                if (notations[n0][1] !== 1) {
                  ...
                  stringResult += notations[n0][0] + options.delimiter_start + (0, _util.toRawKatakana)(notations[n0][2]) + options.delimiter_end;
                }
              }
              ...
              for (let n1 = 0; n1 < notations.length; n1++) {
                if (notations[n1][1] !== 1) {
                  ...
                  stringResult += `<ruby>${notations[n1][0]}<rp>${options.delimiter_start}</rp><rt>${(0, _util.toRawKatakana)(notations[n1][2])}</rt><rp>${options.delimiter_end}</rp></ruby>`;
                }
              }
            } else {
              // raw
              ...
              for (let n6 = 0; n6 < notations.length; n6++) {
                if (notations[n6][1] !== 1) {
                  ...
                  rawResult.push({
                    text: notations[n6][0],
                    reading: (0, _util.toRawKatakana)(notations[n6][2])
                  });
                }
              }
            ...
            if (options.mode === "okurigana") {
              for (let n2 = 0; n2 < notations.length; n2++) {
                if (notations[n2][1] !== 1) {
                  ...
                  stringResult += notations[n2][0] + options.delimiter_start + (0, _util.toRawRomaji)(notations[n2][3], options.romajiSystem) + options.delimiter_end;
                }
              }
            } else if (options.mode === "furigana") {
              stringResult += "<ruby>";
              ...
              for (let n3 = 0; n3 < notations.length; n3++) {
                stringResult += `${notations[n3][0]}<rp>${options.delimiter_start}</rp><rt>${(0, _util.toRawRomaji)(notations[n3][3], options.romajiSystem)}</rt><rp>${options.delimiter_end}</rp>`;
              }
              ...
              for (let n7 = 0; n7 < notations.length; n7++) {
                if (notations[n7][1] !== 1) {
                  ...
                  rawResult.push({
                    text: notations[n7][0],
                    reading: (0, _util.toRawRomaji)(notations[n7][3], options.romajiSystem)
                  });
                }
              }
